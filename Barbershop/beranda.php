...
<body>
    ...
    <!-- Hero Section -->
    <section class="hero">
        <h1>"Selamat datang di Foundation Barbershop! Kami siap memberikan pengalaman potong rambut terbaik untuk Anda. Temukan gaya dan layanan yang tepat di setiap cabang kami!"</h1>
